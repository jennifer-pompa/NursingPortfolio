...
<ul class="actions fit">
	<li><a href="https://docs.google.com/viewer?url=https://raw.githubusercontent.com/jennifer-pompa/NursingPortfolio/blob/master/test.pdf" target="_blank" class="button fit" type="application/pdf">Document Name</a></li>
</ul>
