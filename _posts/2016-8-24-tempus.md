...
<ul class="actions fit">
    <li><a href="#" class="button special fit" onclick="openPDFModal()">View PDF</a></li>
</ul>
...
<div id="pdfModal" class="modal">
    <div class="modal-content">
        ...
        <iframe id="pdfFrame" src="https://github.com/jennifer-pompa/NursingPortfolio/tree/master/documents/test.pdf" width="100%" height="500px"></iframe>
    </div>
</div>
